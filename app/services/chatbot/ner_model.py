...
class Ner_Model:
    def __init__(self):
        ...
        # 의도 분류 모델 불러오기
        self.model = load_model(r"C:\Users\AIA\PycharmProjects\fastapiProject\app\services\chatbot\models\ner\ner_model.h5")
    ...
    def ner_test(self):
        ...
        ner = NerModel(model_name=r"C:\Users\AIA\PycharmProjects\fastapiProject\app\services\chatbot\models\ner\ner_model.h5", proprocess=p)
