...
class MyFaker(object):
    ...
    def create_user(self) -> []:
        ...
        return user_id, email, password, username, phone, birth, address, job, interests,

    def create_users(self) -> []:
        rows = [self.create_user() for i in range(100)]
        columns = ['user_id', 'email', 'password', 'username', 'phone', 'birth', 'address', 'job', 'interests']
